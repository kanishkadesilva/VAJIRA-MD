...
global.owner = [process.env.OWNER_NUMBER] || ['94722477361'] // Owner number , (අයිතිකරුගේ නම්බර් එක )

module.exports = {    
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=WIsTVCDR#eV3vGeTO5tCVMMtoDK-nX0HjEgNKWNskRDZpiBC58ms',
...
OWNER_NUMBER: process.env.OWNER_NUMBER || '94722477361'  ,    
ALIVE: process.env.ALIVE || `default`,
OWNER_NAME: process.env.OWNER_NAME || 'Kanishka' ,     
